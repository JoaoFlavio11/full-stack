import { application, response, type NextFunction, type Request, type Response } from "express"
import {knex} from "../database/knex"
import { z } from "zod"
import AppError from "../utils/appError"
import { ProductRepository } from "../types/productRepository"
...
class ProductController {
  ...
  async update(req: Request, res: Response, next: NextFunction){
    try{
      ...
      await knex<ProductRepository>("products").update({name, price, update_at:knex.fn.now()}).where({ id })
